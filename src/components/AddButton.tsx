...
} from "./plasmic/hub_hub/PlasmicAddButton";
...
interface AddButtonProps extends DefaultAddButtonProps {}

function AddButton_(props: AddButtonProps, ref: HTMLElementRefOf<"div">) {
